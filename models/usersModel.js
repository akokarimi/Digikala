...
const usersSchema = new mongoose.Schema(
  {
    name: {
      ...
      maxlength: [40, "طول نام باید حداکثر ۴۰ کاراکتر باشد"],
    },
    family: {
      type: String,
      required: [true, "لطفاً نام خانوادگی خود را وارد کنید."],
      trim: true,
      minlength: [3, "طول نام خانوادگی باید حداقل ۳ کاراکتر باشد."],
      maxlength: [40, "طول نام خانوادگی باید حداکثر ۴۰ کاراکتر باشد."],
    },
    role: {
      type: String,
      enum: {
