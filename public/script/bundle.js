...
var removeAlret = function removeAlret() {
  var el = document.querySelector(".alert");
  if (el) el.parentElement.removeChild(el);
};
var showAlert = function showAlert(status, message) {
  var markup = "<div class=\"alert alert__".concat(status, "\">").concat(message, "</div>");
      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (res.data.status === "success") {
            (0, _alert.showAlert)("success", "با موفقیت وارد شدید");
        ...
        case 7:
          ...
          (0, _alert.showAlert)("fail", _context.t0.response.data.message);
        case 10:
        case "end":
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 7:
          ...
          (0, _alert.showAlert)("fail", "خروج از حساب با خطا مواجه شد، دوباره امتحان کنید");
        case 10:
        case "end":
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 3:
          res = _context3.sent;
          if (res.data.status === "success") {
            (0, _alert.showAlert)("success", "ثبت‌نام با موفقیت انجام شد");
        ...
        case 7:
          ...
          message = "";
          if (_context3.t0.response.data.error.errors) {
            if (_context3.t0.response.data.error.errors.name) {
              message = message + _context3.t0.response.data.error.errors.name.message;
            }
            if (_context3.t0.response.data.error.errors.family) {
              message = message + _context3.t0.response.data.error.errors.family.message;
            }
            if (_context3.t0.response.data.error.errors.email) {
              message = message + _context3.t0.response.data.error.errors.email.message;
            }
            if (_context3.t0.response.data.error.errors.password) {
              message = message + _context3.t0.response.data.error.errors.password.message;
            }
            if (_context3.t0.response.data.error.errors.confirmPassword) {
              message = message + _context3.t0.response.data.error.errors.confirmPassword.message;
            }
          } else if (_context3.t0.response.data.message.startsWith("E11000")) {
            message = "این ایمیل از قبل وجود دارد";
          } else {
            message = _context3.t0.response.data.message;
          }
          (0, _alert.showAlert)("fail", message);
        case 12:
        case "end":
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"updateProfile.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updateSettings = exports.updatePassword = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alert = require("./alert");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          res = _context.sent;
          if (res.data.status === "success") {
            (0, _alert.showAlert)("success", "تغییرات با موفقیت ذخیره شد");
          }
          _context.next = 14;
          break;
        case 7:
          ...
          _context.t0 = _context["catch"](0);
          message = "";
          if (_context.t0.response.data.error.errors.name) message = message + _context.t0.response.data.error.errors.name.message;
          if (_context.t0.response.data.error.errors.family) message = message + _context.t0.response.data.error.errors.family.message;
          if (_context.t0.response.data.error.errors.email) message = message + _context.t0.response.data.error.errors.email.message;
          (0, _alert.showAlert)("fail", message);
        case 14:
        case "end":
          return _context.stop();
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 7:
          _context2.prev = 7;
          _context2.t0 = _context2["catch"](0);
          if (_context2.t0.response.data.message.includes("confirmPassword:")) {
            msg = _context2.t0.response.data.message.split("confirmPassword:")[1];
            (0, _alert.showAlert)("fail", msg);
          } else {
            (0, _alert.showAlert)("fail", _context2.t0.response.data.message);
          }
        case 10:
        case "end":
          return _context2.stop();
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"registerOrder.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.removeAnOrder = exports.registerAnOrder = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alert = require("./alert");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var registerAnOrder = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(productId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return (0, _axios.default)("/api/users/addToCart/".concat(productId));
        case 2:
          res = _context.sent;
          if (res.data.status === "success") {
            (0, _alert.showAlert)("success", "به سبد خرید اضافه شد");
            window.setTimeout(function () {
  ...
  return function registerAnOrder(_x) {
    return _ref.apply(this, arguments);
  };
}();
exports.registerAnOrder = registerAnOrder;
var removeAnOrder = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(productId) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.next = 2;
          return (0, _axios.default)("/api/users/removeFromCart/".concat(productId));
        case 2:
          res = _context2.sent;
          if (res.data.status === "success") {
            (0, _alert.showAlert)("success", "از سبد خرید حذف شد");
            window.setTimeout(function () {
              location.reload(true);
            }, 1500);
          }
  ...
  return function removeAnOrder(_x2) {
    return _ref2.apply(this, arguments);
  };
}();
exports.removeAnOrder = removeAnOrder;
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"comment.js":[function(require,module,exports) {
"use strict";
...
var addComment = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, productId) {
    var res, message;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: "POST",
            url: "/api/reviews/".concat(productId),
            data: data
          });
        case 3:
          res = _context.sent;
          if (res.data.status === "success") {
            (0, _alert.showAlert)("success", "نظر با موفقیت ثبت شد.");
            window.setTimeout(function () {
              location.assign("/");
            }, 1500);
          }
        ...
        case 7:
          ...
          message = "";
          if (!_context.t0.response.data.error.errors) {
            _context.next = 18;
            break;
          }
          if (_context.t0.response.data.error.errors.title) message = message + _context.t0.response.data.error.errors.title.message;
          if (_context.t0.response.data.error.errors.review) message = message + _context.t0.response.data.error.errors.review.message;
          if (_context.t0.response.data.error.errors.rating) message = message + _context.t0.response.data.error.errors.rating.message;
          return _context.abrupt("return", (0, _alert.showAlert)("fail", message));
        case 18:
          return _context.abrupt("return", (0, _alert.showAlert)(_context.t0.response.data.message));
        case 20:
        case "end":
          return _context.stop();
      }
...
var _registerOrder = require("./registerOrder");
...
// }
////////// comment
var addCommentBtn = document.querySelector(".btn-add-comment");
if (addCommentBtn) {
  addCommentBtn.addEventListener("click", /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 9;
            return (0, _comment.addComment)(data, productId);
          case 9:
          case "end":
            return _context.stop();
        }
...
if (screenCover) {
  ...
  screenCover.addEventListener("mouseover", function (e) {
    e.preventDefault();
...
var registerBtn = document.querySelectorAll(".addtocart");
var removeBtn = document.querySelectorAll(".removefromcart");
if (registerBtn) {
  registerBtn.forEach(function (el) {
    return el.addEventListener("click", function (e) {
      e.preventDefault();
      var productId = e.target.dataset.productId;
      (0, _registerOrder.registerAnOrder)(productId);
    });
  });
}
if (removeBtn) {
  removeBtn.forEach(function (el) {
    return el.addEventListener("click", function (e) {
      e.preventDefault();
      var productId = e.target.dataset.productId;
      (0, _registerOrder.removeAnOrder)(productId);
    });
  });
}

////////// Singup
var btnSignup = document.querySelector(".signup-btn-2");
if (btnSignup) {
  var data = {
    name: "",
    family: "",
...
var btnUpdateSettings = document.querySelector(".btn-profile-changesetting");
if (btnUpdateSettings) {
  ...
  btnUpdateSettings.addEventListener("click", function (e) {
    e.preventDefault();
    _data.name = document.getElementById("profile__form-name").value;
    _data.family = document.getElementById("profile__form-family").value;
    _data.email = document.getElementById("profile__form-email").value;
    (0, _updateProfile.updateSettings)(_data);
  });
}
var btnUpdatePassword = document.querySelector(".btn-profile-updatepassword");
if (btnUpdatePassword) {
  ...
  btnUpdatePassword.addEventListener("click", /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _data2.passwordCurrent = document.getElementById("profile__form-passwordCurrent").value;
            _data2.password = document.getElementById("profile__form-password").value;
            _data2.confirmPassword = document.getElementById("profile__form-confirmPassword").value;
            _context2.next = 7;
            return (0, _updateProfile.updatePassword)(_data2);
          case 7:
...
///////// logout
var logoutButton = document.querySelector(".profile-modal__logout");
if (logoutButton) {
...
var mainNav = document.querySelectorAll(".navigationd__right-item");
var underLine = document.querySelector(".under-line");
if (mainNav) {
  mainNav.forEach(function (item) {
    item.addEventListener("mouseenter", function (e) {
      var pointZero = mainNav[0].getBoundingClientRect().left;
      var coords = item.getBoundingClientRect().left - pointZero;
      underLine.style.width = "".concat(item.getBoundingClientRect().width, "px");
      underLine.style.transform = "translateX(".concat(coords, "px)");
    });
  });
  mainNav.forEach(function (item) {
...
var sliderOne = document.getElementById("min-slider");
var sliderTwo = document.getElementById("max-slider");
var displayValOne = document.querySelector(".slider__prices-min");
var displayValTwo = document.querySelector(".slider__prices-max");
var minGap = 0;
var sliderTrack = document.querySelector(".slider-track");
var sliderMaxValue = document.getElementById("min-slider");
...
function slideOne() {
  if (sliderOne && sliderTwo) {
    ...
    var content = new Intl.NumberFormat("fa-IR").format(sliderOne.value);
...
function slideTwo() {
  if (sliderOne && sliderTwo) {
    ...
    var content = new Intl.NumberFormat("fa-IR").format(sliderTwo.value);
    displayValTwo.textContent = content;
    fillColor();
  }
}
function fillColor() {
  var percent1 = sliderOne.value / sliderMaxValue.max * 100;
  var percent2 = sliderTwo.value / sliderMaxValue.max * 100;
  sliderTrack.style.background = "linear-gradient(to left, #dadae5 ".concat(percent1, "% , #00bac7 ").concat(percent1, "% , #00bac7 ").concat(percent2, "%, #dadae5 ").concat(percent2, "%)");
}

///////// Filters and sorting

var openFilters = document.querySelector(".filters-openicon");
var openSorting = document.querySelector(".sorting-openicon");
var closeFilters = document.querySelector(".filters__title-closeicon");
var closeSorting = document.querySelector(".content__sorting-desktop-title-closeicon");
var filtersWindow = document.querySelector(".filters");
var sortingWindow = document.querySelector(".content__sorting-desktop-list");
var modelaIsOpen = false;
var modalController = function modalController() {
  if (filtersWindow) {
    if (document.body.getBoundingClientRect().width <= 1024 && modelaIsOpen === false) {
...
if (filtersWindow) {
  ...
  closeFilters.addEventListener("click", function () {
    ...
    filtersWindow.style.width = "0";
    filtersWindow.style.height = "0";
    var scrollY = document.body.getBoundingClientRect().top;
...
var elementSellerInfo = document.querySelector(".sellercard-info");
var elementSellerModal = document.querySelector(".sellermodal");
...
var containerSmallImages = document.querySelector(".product__image-bottom-small");
var mainImage = document.querySelector(".product__image-top-main");
var containerMainImage = document.querySelector(".product__mainimagebox");
var hoverBox = document.querySelector(".hoverzoom-hoverbox");
var zoomBox = document.querySelector(".hoverzoom-box");
var zoomImg = document.querySelector(".hoverzoom-img");
if (mainImage) {
  ...
  hoverBox.addEventListener("mousemove", function (e) {
    if (window.innerWidth > 1024) {
      e.preventDefault();
      hoverBox.style.left = "".concat(e.pageX, "px");
      hoverBox.style.top = "".concat(e.pageY, "px");
      zoomImg.style.transform = "translateX(".concat(mainImage.getBoundingClientRect().right - e.pageX, "px)");
      zoomImg.style.transform = "translateY(".concat(mainImage.getBoundingClientRect().top - e.pageY, "px)");
    }
  });
  ...
  document.body.addEventListener("mousemove", function (e) {
    if (e.pageX >= mainImage.getBoundingClientRect().right || e.pageX <= mainImage.getBoundingClientRect().left || e.pageY >= mainImage.getBoundingClientRect().bottom || e.pageY <= mainImage.getBoundingClientRect().top) {
...
},{"./login":"login.js","./updateProfile":"updateProfile.js","./registerOrder":"registerOrder.js","./comment":"comment.js"}],"../../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "2265" + '/');
